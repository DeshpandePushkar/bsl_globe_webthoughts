...
import { Input, Button, Checkbox, Typography, Row, Col, Select, Collapse } from 'antd';
import { useLanguage } from "../hooks/useLanguage";
import { useNavigate } from 'react-router-dom';

const { Title, Text, Paragraph } = Typography;

const StepThreePageTwo = () => {
  const { t } = useLanguage();
        ...
        <Collapse defaultActiveKey={['1']} className='step-three-page-tow-collapse' ghost items={[
          {
            ...
            children: <div className="steps-container">
              <div className="steps-list">
                ...
                <div className='step-id-selfie'>
                  <img src="/assets/step3-2/2.svg" width={40} />
                  <div className="step-item-id-selfie">
                    <span className='step-sub-item_id_selfie'>
                ...
                <div className='step-id-selfie'>
                  <img src="/assets/step3-2/3.svg" width={40} />
                  <div className="step-item-id-selfie">
                    <span className='step-sub-item_id_selfie'>
                ...
                <div className='step-id-selfie'>
                  <img src="/assets/step3-2/4.svg" width={40} />
                  <div className="step-item-id-selfie">
                    <span className='step-sub-item_id_selfie'>
                ...
                <div className='step-id-selfie'>
                  <img src="/assets/step3-2/5.svg" width={40} />
                  <div className="step-item-id-selfie">
                    <span className='step-sub-item_id_selfie'>
                ...
                <div className='step-id-selfie'>
                  <img src="/assets/step3-2/6.svg" width={40} />
                  <div className="step-item-id-selfie">
                    <span className='step-sub-item_id_selfie'>
                ...
                <div className='step-id-selfie'>
                  <img src="/assets/step3-2/7.svg" width={40} />
                  <div className="step-item-id-selfie">
                    <span className='step-sub-item_id_selfie'>
                ...
                <div className='step-id-selfie'>
                  <img src="/assets/step3-2/8.svg" width={40} />
                  <div className="step-item-id-selfie">
                    <span className='step-sub-item_id_selfie'>
...
export default StepThreePageTwo;